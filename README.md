...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=20&pause=1000&color=2E9EF7&center=true&vCenter=true&width=500&lines=Studying+Software+Development;Learning+Java+%7C+PHP+%7C+JavaScript;Looking+for+my+first+Junior+Dev+opportunity" alt="Typing SVG" />
</p>
...
- 💻 I'm currently building solid foundations in **Java**, **PHP**, and web development.
- 🚀 I'm looking to break into the **IT field** and land my **first Junior Developer position**.
- 📚 I'm always learning: currently studying **Object-Oriented Programming, databases, and web fundamentals**.
- 🎯 My current goal is to build a strong portfolio while applying for entry-level dev roles.
...
and update this section with the rest of your real projects, descriptions,
and tech stacks.
-->
...
<p align="center"><i>Open to Junior Developer opportunities — always eager to learn and grow.</i></p>
